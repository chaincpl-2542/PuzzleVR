	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 weightedBlend9_g37 = ( weightedBlendVar9_g37.x*( ( (Control26_g37).rrr * (_DiffuseRemapScale0).rgb ) * Splat0342_g37 ) + weightedBlendVar9_g37.y*( ( (Control26_g37).ggg * (_DiffuseRemapScale1).rgb ) * Splat1379_g37 ) + weightedBlendVar9_g37.z*( ( (Control26_g37).bbb * (_DiffuseRemapScale2).rgb ) * Splat2357_g37 ) + weightedBlendVar9_g37.w*( ( (Control26_g37).aaa * (_DiffuseRemapScale3).rgb ) * Splat3390_g37 ) );
				...
				float weightedBlend536_g37 = ( weightedBlendVar536_g37.x*( ( 1.0 - _Metallic0 ) * Mask0R334_g37 ) + weightedBlendVar536_g37.y*( ( 1.0 - _Metallic1 ) * Mask1R370_g37 ) + weightedBlendVar536_g37.z*( ( 1.0 - _Metallic2 ) * Mask2R359_g37 ) + weightedBlendVar536_g37.w*( ( 1.0 - _Metallic3 ) * Mask3R388_g37 ) );
				
				float Mask0A335_g37 = tex2DNode416_g37.a;
				float Mask1A369_g37 = tex2DNode422_g37.a;
				float Mask2A360_g37 = tex2DNode419_g37.a;
				float Mask3A391_g37 = tex2DNode425_g37.a;
				float4 weightedBlendVar547_g37 = Control26_g37;
				float weightedBlend547_g37 = ( weightedBlendVar547_g37.x*( ( 1.0 - _Smoothness0 ) * Mask0A335_g37 ) + weightedBlendVar547_g37.y*( ( 1.0 - _Smoothness1 ) * Mask1A369_g37 ) + weightedBlendVar547_g37.z*( ( 1.0 - _Smoothness2 ) * Mask2A360_g37 ) + weightedBlendVar547_g37.w*( ( 1.0 - _Smoothness3 ) * Mask3A391_g37 ) );
				...
				float Smoothness = weightedBlend547_g37;
...
Node;AmplifyShaderEditor.FunctionNode;72;336.8021,40.57027;Inherit;False;Terrain 4 Layer;0;;37;a8a57459582f78d4ca5db58f601fb616;4,504,1,102,1,668,0,669,0;0;8;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;282;FLOAT3;709;FLOAT4;701
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;51;645.0565,40.11808;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;12;AmplifyShaderPack/Terrain/Simple;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;19;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;;False;True;0;False;;False;False;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;5;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=-100;UniversalMaterialType=Lit;TerrainCompatible=True;True;5;True;12;all;0;False;True;1;1;False;;0;False;;1;1;False;;0;False;;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;;False;False;False;False;False;False;False;True;False;0;False;;255;False;;255;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;0;False;;False;True;1;False;;True;3;False;;True;True;0;False;;0;False;;True;2;LightMode=UniversalForwardOnly;TerrainCompatible=True;False;False;4;Include;;False;;Native;False;0;0;;Define;TERRAIN_SPLAT_FIRSTPASS 1;False;;Custom;False;0;0;;Pragma;instancing_options assumeuniformscaling nomatrices nolightprobe nolightmap;False;;Custom;True;0;0;Forward, GBuffer;Pragma;multi_compile_instancing;False;;Custom;True;0;0;Forward,GBuffer,ShadowCaster,DepthOnly,DepthNormals;Off;16;BaseMapShader=Hidden/AmplifyShaderPack/Terrain/Simple BasePass;AddPassShader=Hidden/AmplifyShaderPack/Terrain/Simple AddPass;BaseMapShader=Hidden/AmplifyShaderPack/Terrain/Simple BasePass;AddPassShader=Hidden/AmplifyShaderPack/Terrain/Simple AddPass;BaseMapShader=Hidden/AmplifyShaderPack/Terrain/Simple BasePass;AddPassShader=Hidden/AmplifyShaderPack/Terrain/Simple AddPass;BaseMapShader=Hidden/AmplifyShaderPack/Terrain/Simple BasePass;AddPassShader=Hidden/AmplifyShaderPack/Terrain/Simple AddPass;BaseMapShader=Hidden/AmplifyShaderPack/Terrain/Simple BasePass;AddPassShader=Hidden/AmplifyShaderPack/Terrain/Simple AddPass;BaseMapShader=Hidden/AmplifyShaderPack/Terrain/Simple BasePass;AddPassShader=Hidden/AmplifyShaderPack/Terrain/Simple AddPass;BaseMapShader=Hidden/AmplifyShaderPack/Terrain/Simple BasePass;AddPassShader=Hidden/AmplifyShaderPack/Terrain/Simple AddPass;BaseMapShader=Hidden/AmplifyShaderPack/Terrain/Simple BasePass;AddPassShader=Hidden/AmplifyShaderPack/Terrain/Simple AddPass;0;Standard;36;Workflow;1;0;Surface;0;0;  Refraction Model;0;0;  Blend;0;0;Two Sided;1;0;Fragment Normal Space,InvertActionOnDeselection;0;0;Transmission;0;0;  Transmission Shadow;0.5,False,;0;Translucency;0;0;  Translucency Strength;1,False,;0;  Normal Distortion;0.5,False,;0;  Scattering;2,False,;0;  Direct;0.9,False,;0;  Ambient;0.1,False,;0;  Shadow;0.5,False,;0;Cast Shadows;0;638162445753263295;  Use Shadow Threshold;0;0;GPU Instancing;0;638162456717211447;LOD CrossFade;0;638162445856431097;Built-in Fog;1;0;_FinalColorxAlpha;1;638162445897066981;Meta Pass;1;0;Override Baked GI;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,;0;  Type;0;0;  Tess;16,False,;0;  Min;10,False,;0;  Max;25,False,;0;  Edge Length;16,False,;0;  Max Displacement;25,False,;0;Write Depth;0;0;  Early Z;0;0;Vertex Position,InvertActionOnDeselection;1;0;0;8;False;True;False;True;True;True;True;False;True;;True;0
...
ASEEND*/
//CHKSM=8D761027428891220661E582F551CD2787E0BDAD