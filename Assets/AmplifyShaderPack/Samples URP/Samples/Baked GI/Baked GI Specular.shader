	...
	SubShader
	{
		...
		Pass
		{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float2 temp_output_1255_0_g8 = (IN.ase_texcoord7.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				...
				float3 SRP_Lambert_Half1362_g8 = localAdditionalLightsHalfLambertMask10x150_g25;
				...
				float2 temp_output_1219_0_g8 = (IN.ase_texcoord8.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				...
				float3 WorldPosition156_g12 = worldPosValue184_g12;
				...
				float3 WorldNormal156_g12 = worldNormalValue185_g12;
				float3 temp_output_15_0_g12 = WorldViewDirection;
				float3 WorldView156_g12 = temp_output_15_0_g12;
				float3 temp_output_1196_0_g8 = (_IndirectSpecularColor).rgb;
				float3 temp_output_14_0_g12 = temp_output_1196_0_g8;
				float3 SpecColor156_g12 = temp_output_14_0_g12;
				float temp_output_18_0_g12 = _IndirectSpecularSmoothness;
				float Smoothness156_g12 = temp_output_18_0_g12;
				float3 localAdditionalLightsSpecular10x12x156_g12 = AdditionalLightsSpecular10x12x( WorldPosition156_g12 , WorldNormal156_g12 , WorldView156_g12 , SpecColor156_g12 , Smoothness156_g12 );
				...
				float3 temp_output_1202_0_g8 = ( localAdditionalLightsSpecular10x12x156_g12 + temp_output_1192_0_g8 );
				float3 temp_cast_4 = (1.0).xxx;
				half3 reflectVector1296_g8 = reflect( -WorldViewDirection, worldNormal1260_g8 );
				float3 indirectSpecular1296_g8 = GlossyEnvironmentReflection( reflectVector1296_g8, 1.0 - _IndirectSpecularSmoothness, _IndirectSpecularOcclusion );
				float3 lerpResult1266_g8 = lerp( temp_cast_4 , ( indirectSpecular1296_g8 + step( float3( 1,1,1 ) , ( 1.0 - indirectSpecular1296_g8 ) ) ) , _IndirectSpecular);
				float3 BaseColor1240_g8 = temp_output_898_0_g8;
				float3 switchResult1238_g8 = (((ase_vface>0)?(( temp_output_1202_0_g8 + lerpResult1266_g8 )):(BaseColor1240_g8)));
				...
				float2 temp_output_1219_0_g28 = (IN.ase_texcoord8.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g28 = temp_output_1219_0_g28;
				float2 staticUV965_g28 = UV1Static1247_g28;
				float2 temp_output_1255_0_g28 = (IN.ase_texcoord7.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 worldNormalValue185_g25 = worldNormal12_g25;
				float3 WorldNormal150_g25 = worldNormalValue185_g25;
				float2 temp_output_1255_0_g8 = (IN.ase_texcoord2.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g8 = temp_output_1255_0_g8;
				half2 LightmapUV1_g23 = UV2Dynamic1251_g8;
				half4 localCalculateShadowMask1_g23 = CalculateShadowMask1_g23( LightmapUV1_g23 );
				float4 shadowMaskValue182_g25 = localCalculateShadowMask1_g23;
				...
				float3 tanNormal1158_g8 = Normal1069_g8;
				float3 worldNormal1158_g8 = normalize( float3(dot(tanToWorld0,tanNormal1158_g8), dot(tanToWorld1,tanNormal1158_g8), dot(tanToWorld2,tanNormal1158_g8)) );
				float2 temp_output_1219_0_g8 = (IN.ase_texcoord6.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g8 = temp_output_1219_0_g8;
				float3 bakedGI1252_g8 = ASEBakedGI( worldNormal1158_g8, UV1Static1247_g8, true);
				float3 lerpResult1169_g8 = lerp( float3( 1,1,1 ) , ( SRP_Lambert_Half1362_g8 + bakedGI1252_g8 ) , _IndirectDiffuse);
				float3 temp_output_1173_0_g8 = ( lerpResult1169_g8 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g8 ) ) );
				...
				float3 temp_output_1202_0_g8 = ( localAdditionalLightsSpecular10x12x156_g12 + temp_output_1192_0_g8 );
				float3 temp_cast_4 = (1.0).xxx;
				half3 reflectVector1296_g8 = reflect( -ase_worldViewDir, worldNormal1260_g8 );
				float3 indirectSpecular1296_g8 = GlossyEnvironmentReflection( reflectVector1296_g8, 1.0 - _IndirectSpecularSmoothness, _IndirectSpecularOcclusion );
				float3 lerpResult1266_g8 = lerp( temp_cast_4 , ( indirectSpecular1296_g8 + step( float3( 1,1,1 ) , ( 1.0 - indirectSpecular1296_g8 ) ) ) , _IndirectSpecular);
				float3 BaseColor1240_g8 = temp_output_898_0_g8;
				float3 switchResult1238_g8 = (((ase_vface>0)?(( temp_output_1202_0_g8 + lerpResult1266_g8 )):(BaseColor1240_g8)));
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.FunctionNode;33;-176,0;Inherit;False;Material Sample;1;;7;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;12;FLOAT3;1;FLOAT3;6;FLOAT3;372;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
...
Node;AmplifyShaderEditor.FunctionNode;34;144,-80;Inherit;False;Material Lighting;40;;8;b5db59747a6f5584db32cde93c4695e4;9,1290,0,1289,0,1288,0,1074,0,1322,0,1323,0,1280,1,1128,1,1378,1;8;898;FLOAT3;0,0,0;False;975;FLOAT3;0,0,1;False;1081;FLOAT;0;False;1079;FLOAT;0;False;1077;FLOAT;0;False;1075;FLOAT;0;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;1;FLOAT3;894
Node;AmplifyShaderEditor.FunctionNode;50;144,208;Inherit;False;Material Baked GI;35;;28;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;4;975;FLOAT3;0,0,1;False;765;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
...
ASEEND*/
//CHKSM=6BCD0BD0CD209021FE75902D99CCF59C29663CFE