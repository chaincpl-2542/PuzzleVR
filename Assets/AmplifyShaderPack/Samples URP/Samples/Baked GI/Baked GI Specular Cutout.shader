...
Shader "AmplifyShaderPack/Baked GI Specular Cutout"
{
	...
	SubShader
	{
		...
		Pass
		{
			...
			float3 AdditionalLightsHalfLambertMask10x( float3 WorldPosition, float3 WorldNormal, float4 ShadowMask )
			{
				float3 Color = 0;
			...
			float4 URPDecodeInstruction984_g31(  )
			{
						...
						, bool ase_vface : SV_IsFrontFace ) : SV_Target
			{
				...
				float3 WorldPosition150_g25 = worldPosValue184_g25;
				...
				float3 temp_output_975_0_g15 = temp_output_33_6;
				float3 Normal1069_g15 = temp_output_975_0_g15;
				float3 tanToWorld0 = float3( WorldTangent.x, WorldBiTangent.x, WorldNormal.x );
				float3 tanToWorld1 = float3( WorldTangent.y, WorldBiTangent.y, WorldNormal.y );
				float3 tanToWorld2 = float3( WorldTangent.z, WorldBiTangent.z, WorldNormal.z );
				float3 tanNormal12_g25 = Normal1069_g15;
				...
				float3 WorldNormal150_g25 = worldNormalValue185_g25;
				float2 temp_output_1255_0_g15 = (IN.ase_texcoord7.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g15 = temp_output_1255_0_g15;
				half2 LightmapUV1_g23 = UV2Dynamic1251_g15;
				...
				float4 ShadowMask150_g25 = shadowMaskValue182_g25;
				float3 localAdditionalLightsHalfLambertMask10x150_g25 = AdditionalLightsHalfLambertMask10x( WorldPosition150_g25 , WorldNormal150_g25 , ShadowMask150_g25 );
				float3 SRP_Lambert_Half1362_g15 = localAdditionalLightsHalfLambertMask10x150_g25;
				float3 tanNormal1158_g15 = Normal1069_g15;
				float3 worldNormal1158_g15 = normalize( float3(dot(tanToWorld0,tanNormal1158_g15), dot(tanToWorld1,tanNormal1158_g15), dot(tanToWorld2,tanNormal1158_g15)) );
				float2 temp_output_1219_0_g15 = (IN.ase_texcoord8.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g15 = temp_output_1219_0_g15;
				float3 bakedGI1252_g15 = ASEBakedGI( worldNormal1158_g15, UV1Static1247_g15, true);
				float3 lerpResult1169_g15 = lerp( float3( 1,1,1 ) , ( SRP_Lambert_Half1362_g15 + bakedGI1252_g15 ) , _IndirectDiffuse);
				float3 temp_output_1173_0_g15 = ( lerpResult1169_g15 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g15 ) ) );
				float3 tanNormal1072_g15 = temp_output_975_0_g15;
				float3 worldNormal1072_g15 = normalize( float3(dot(tanToWorld0,tanNormal1072_g15), dot(tanToWorld1,tanNormal1072_g15), dot(tanToWorld2,tanNormal1072_g15)) );
				float3 normalizeResult1044_g15 = ASESafeNormalize( ( WorldViewDirection + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult1046_g15 = dot( worldNormal1072_g15 , normalizeResult1044_g15 );
				float Dot_NdotH1098_g15 = dotResult1046_g15;
				float temp_output_1108_0_g15 = ( 1.0 - ( ( 1.0 - Dot_NdotH1098_g15 ) * _MainLightPosition.w ) );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				float4 ase_lightColor = float4( _MainLightColor.rgb / ase_lightIntensity, ase_lightIntensity );
				float LightColorIntensity1349_g15 = max( ase_lightColor.a , 0.0 );
				float3 temp_output_1112_0_g15 = ( temp_output_1173_0_g15 * temp_output_1108_0_g15 * LightColorIntensity1349_g15 );
				float dotResult1055_g15 = dot( worldNormal1072_g15 , SafeNormalize(_MainLightPosition.xyz) );
				float Dot_NdotL1100_g15 = dotResult1055_g15;
				float Shadow_Strength1138_g15 = _ShadowStrength;
				float lerpResult1130_g15 = lerp( ( Shadow_Strength1138_g15 * Shadow_Strength1138_g15 * 0.7978846 ) , ( Shadow_Strength1138_g15 * Shadow_Strength1138_g15 * sqrt( ( 2.0 / ( 2.0 * PI ) ) ) ) , _ShadowApproxmation);
				float temp_output_1312_0_g15 = ( ( max( Dot_NdotL1100_g15 , 0.0 ) * lerpResult1130_g15 ) + ( 1.0 - lerpResult1130_g15 ) );
				float temp_output_1117_0_g15 = saturate( ( ( ( max( Dot_NdotH1098_g15 , 0.0 ) * temp_output_1312_0_g15 * temp_output_1312_0_g15 ) + _ShadowOffset ) / _ShadowSharpness ) );
				float3 temp_cast_1 = (temp_output_1117_0_g15).xxx;
				float3 temp_cast_2 = (temp_output_1117_0_g15).xxx;
				float3 lerpResult1379_g15 = lerp( (_ShadowColor).rgb , temp_cast_2 , temp_output_1117_0_g15);
				float3 lerpResult1377_g15 = lerp( temp_cast_1 , lerpResult1379_g15 , _ShadowColorEnable);
				float3 temp_cast_3 = (temp_output_1108_0_g15).xxx;
				float3 lerpResult1109_g15 = lerp( ( lerpResult1377_g15 * Dot_NdotH1098_g15 ) , temp_cast_3 , _ShadowStrength);
				...
				float3 temp_output_898_0_g15 = temp_output_89_0_g14;
				float3 temp_output_1210_0_g15 = saturate( ( ( temp_output_1112_0_g15 + lerpResult1109_g15 ) * temp_output_898_0_g15 ) );
				float3 worldPosValue184_g16 = WorldPosition;
				float3 WorldPosition156_g16 = worldPosValue184_g16;
				float3 tanNormal1260_g15 = Normal1069_g15;
				float3 worldNormal1260_g15 = normalize( float3(dot(tanToWorld0,tanNormal1260_g15), dot(tanToWorld1,tanNormal1260_g15), dot(tanToWorld2,tanNormal1260_g15)) );
				float3 worldNormalValue185_g16 = worldNormal1260_g15;
				float3 WorldNormal156_g16 = worldNormalValue185_g16;
				float3 temp_output_15_0_g16 = WorldViewDirection;
				float3 WorldView156_g16 = temp_output_15_0_g16;
				float3 temp_output_1196_0_g15 = (_IndirectSpecularColor).rgb;
				float3 temp_output_14_0_g16 = temp_output_1196_0_g15;
				float3 SpecColor156_g16 = temp_output_14_0_g16;
				float temp_output_18_0_g16 = _IndirectSpecularSmoothness;
				float Smoothness156_g16 = temp_output_18_0_g16;
				float3 localAdditionalLightsSpecular10x12x156_g16 = AdditionalLightsSpecular10x12x( WorldPosition156_g16 , WorldNormal156_g16 , WorldView156_g16 , SpecColor156_g16 , Smoothness156_g16 );
				float3 LightColorAtten1105_g15 = ( Dot_NdotH1098_g15 * ase_lightColor.rgb );
				float3 normalizeResult1197_g15 = normalize( ( WorldViewDirection + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult1187_g15 = dot( normalizeResult1197_g15 , worldNormal1260_g15 );
				float3 temp_output_1192_0_g15 = ( temp_output_1196_0_g15 * LightColorAtten1105_g15 * pow( max( dotResult1187_g15 , 0.0 ) , exp2( (_IndirectSpecularSmoothness*10.0 + 1.0) ) ) );
				float3 temp_output_1202_0_g15 = ( localAdditionalLightsSpecular10x12x156_g16 + temp_output_1192_0_g15 );
				float3 temp_cast_4 = (1.0).xxx;
				half3 reflectVector1296_g15 = reflect( -WorldViewDirection, worldNormal1260_g15 );
				float3 indirectSpecular1296_g15 = GlossyEnvironmentReflection( reflectVector1296_g15, 1.0 - _IndirectSpecularSmoothness, _IndirectSpecularOcclusion );
				float3 lerpResult1266_g15 = lerp( temp_cast_4 , ( indirectSpecular1296_g15 + step( float3( 1,1,1 ) , ( 1.0 - indirectSpecular1296_g15 ) ) ) , _IndirectSpecular);
				float3 BaseColor1240_g15 = temp_output_898_0_g15;
				float3 switchResult1238_g15 = (((ase_vface>0)?(( temp_output_1202_0_g15 + lerpResult1266_g15 )):(BaseColor1240_g15)));
				float fresnelNdotV1262_g15 = dot( worldNormal1260_g15, WorldViewDirection );
				float fresnelNode1262_g15 = ( 0.04 + _IndirectSpecularSmoothness * pow( 1.0 - fresnelNdotV1262_g15, 5.0 ) );
				float3 lerpResult1236_g15 = lerp( temp_output_1210_0_g15 , switchResult1238_g15 , saturate( fresnelNode1262_g15 ));
				
				float3 temp_output_202_0_g14 = (_SpecularColor).rgb;
				
				float MapBaseColorAlpha107_g14 = tex2DNode21_g14.a;
				
				float localSampleLightmapBicubic965_g31 = ( 0.0 );
				float3 temp_output_975_0_g31 = temp_output_33_6;
				float3 tanNormal1070_g31 = temp_output_975_0_g31;
				float3 worldNormal1070_g31 = float3(dot(tanToWorld0,tanNormal1070_g31), dot(tanToWorld1,tanNormal1070_g31), dot(tanToWorld2,tanNormal1070_g31));
				float3 NormalWS1073_g31 = worldNormal1070_g31;
				float3 normalWS965_g31 = NormalWS1073_g31;
				float3 temp_output_1063_0_g31 = ( worldNormal1070_g31 * float3( -1,-1,-1 ) );
				float3 BackNormalWS1101_g31 = temp_output_1063_0_g31;
				float3 backNormalWS965_g31 = BackNormalWS1101_g31;
				...
				float2 staticUV965_g31 = UV1Static1247_g31;
				float2 temp_output_1255_0_g31 = (IN.ase_texcoord7.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g31 = temp_output_1255_0_g31;
				float2 dynamicUV965_g31 = UV2Dynamic1251_g31;
				float3 bakeDiffuseLighting965_g31 = float3( 0,0,0 );
				float3 backBakeDiffuseLighting965_g31 = float3( 0,0,0 );
				float4 localURPDecodeInstruction984_g31 = URPDecodeInstruction984_g31();
				float4 decodeInstructions965_g31 = localURPDecodeInstruction984_g31;
				float localSampleDirectionBicubic961_g31 = ( 0.0 );
				float2 staticUV961_g31 = UV1Static1247_g31;
				float2 dynamicUV961_g31 = UV2Dynamic1251_g31;
				float4 staticDir961_g31 = float4( 0,0,0,0 );
				float4 dynamicDir961_g31 = float4( 0,0,0,0 );
				{
				    ...
				    float4 texSize;
				        ...
				        texSize = float4( width, height, 1.0 / float2( width, height ) );
				        staticDir961_g31 = SampleTexture2DBicubic( LM_IND_NAME, LM_SAMPLER, staticUV961_g31, texSize, float2( 1, 1 ), LM_SLICE );
				    #endif
				    #if defined( DYNAMICLIGHTMAP_ON )
				        unity_DynamicDirectionality.GetDimensions( width, height );
				        texSize = float4( width, height, 1.0 / float2( width, height ) );
				        dynamicDir961_g31 = SampleTexture2DBicubic( unity_DynamicDirectionality, samplerunity_DynamicLightmap, dynamicUV961_g31, texSize, float2( 1, 1 ), 0 );
				    #endif
				#endif
				}
				float4 staticDir965_g31 = staticDir961_g31;
				float4 dynamicDir965_g31 = dynamicDir961_g31;
				SampleLightmapBicubic( normalWS965_g31 , backNormalWS965_g31 , staticUV965_g31 , dynamicUV965_g31 , bakeDiffuseLighting965_g31 , backBakeDiffuseLighting965_g31 , decodeInstructions965_g31 , staticDir965_g31 , dynamicDir965_g31 );
				float3 lerpResult941_g31 = lerp( float3( 0,0,0 ) , bakeDiffuseLighting965_g31 , _BakedGIEnable);
				

				float3 BaseColor = lerpResult1236_g15;
				...
				float3 BakedGI = lerpResult941_g31;
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord6.xy = v.texcoord1.xy;
			...
			half4 frag(VertexOutput IN , bool ase_vface : SV_IsFrontFace ) : SV_TARGET
			{
				...
				float3 worldNormalValue185_g25 = worldNormal12_g25;
				float3 WorldNormal150_g25 = worldNormalValue185_g25;
				float2 temp_output_1255_0_g15 = (IN.ase_texcoord2.zw*(unity_DynamicLightmapST).xy + (unity_DynamicLightmapST).zw);
				float2 UV2Dynamic1251_g15 = temp_output_1255_0_g15;
				half2 LightmapUV1_g23 = UV2Dynamic1251_g15;
				half4 localCalculateShadowMask1_g23 = CalculateShadowMask1_g23( LightmapUV1_g23 );
				float4 shadowMaskValue182_g25 = localCalculateShadowMask1_g23;
				...
				float3 tanNormal1158_g15 = Normal1069_g15;
				float3 worldNormal1158_g15 = normalize( float3(dot(tanToWorld0,tanNormal1158_g15), dot(tanToWorld1,tanNormal1158_g15), dot(tanToWorld2,tanNormal1158_g15)) );
				float2 temp_output_1219_0_g15 = (IN.ase_texcoord6.xy*(unity_LightmapST).xy + (unity_LightmapST).zw);
				float2 UV1Static1247_g15 = temp_output_1219_0_g15;
				float3 bakedGI1252_g15 = ASEBakedGI( worldNormal1158_g15, UV1Static1247_g15, true);
				float3 lerpResult1169_g15 = lerp( float3( 1,1,1 ) , ( SRP_Lambert_Half1362_g15 + bakedGI1252_g15 ) , _IndirectDiffuse);
				float3 temp_output_1173_0_g15 = ( lerpResult1169_g15 + step( float3( 1,1,1 ) , ( 1.0 - lerpResult1169_g15 ) ) );
				...
				float3 normalizeResult1044_g15 = ASESafeNormalize( ( ase_worldViewDir + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult1046_g15 = dot( worldNormal1072_g15 , normalizeResult1044_g15 );
				float Dot_NdotH1098_g15 = dotResult1046_g15;
				float temp_output_1108_0_g15 = ( 1.0 - ( ( 1.0 - Dot_NdotH1098_g15 ) * _MainLightPosition.w ) );
				float ase_lightIntensity = max( max( _MainLightColor.r, _MainLightColor.g ), _MainLightColor.b );
				...
				float3 temp_output_15_0_g16 = ase_worldViewDir;
				float3 WorldView156_g16 = temp_output_15_0_g16;
				float3 temp_output_1196_0_g15 = (_IndirectSpecularColor).rgb;
				float3 temp_output_14_0_g16 = temp_output_1196_0_g15;
				float3 SpecColor156_g16 = temp_output_14_0_g16;
				...
				float3 localAdditionalLightsSpecular10x12x156_g16 = AdditionalLightsSpecular10x12x( WorldPosition156_g16 , WorldNormal156_g16 , WorldView156_g16 , SpecColor156_g16 , Smoothness156_g16 );
				float3 LightColorAtten1105_g15 = ( Dot_NdotH1098_g15 * ase_lightColor.rgb );
				float3 normalizeResult1197_g15 = normalize( ( ase_worldViewDir + SafeNormalize(_MainLightPosition.xyz) ) );
				float dotResult1187_g15 = dot( normalizeResult1197_g15 , worldNormal1260_g15 );
				float3 temp_output_1192_0_g15 = ( temp_output_1196_0_g15 * LightColorAtten1105_g15 * pow( max( dotResult1187_g15 , 0.0 ) , exp2( (_IndirectSpecularSmoothness*10.0 + 1.0) ) ) );
				float3 temp_output_1202_0_g15 = ( localAdditionalLightsSpecular10x12x156_g16 + temp_output_1192_0_g15 );
				float3 temp_cast_4 = (1.0).xxx;
				half3 reflectVector1296_g15 = reflect( -ase_worldViewDir, worldNormal1260_g15 );
				float3 indirectSpecular1296_g15 = GlossyEnvironmentReflection( reflectVector1296_g15, 1.0 - _IndirectSpecularSmoothness, _IndirectSpecularOcclusion );
				float3 lerpResult1266_g15 = lerp( temp_cast_4 , ( indirectSpecular1296_g15 + step( float3( 1,1,1 ) , ( 1.0 - indirectSpecular1296_g15 ) ) ) , _IndirectSpecular);
				float3 BaseColor1240_g15 = temp_output_898_0_g15;
				float3 switchResult1238_g15 = (((ase_vface>0)?(( temp_output_1202_0_g15 + lerpResult1266_g15 )):(BaseColor1240_g15)));
				float fresnelNdotV1262_g15 = dot( worldNormal1260_g15, ase_worldViewDir );
				float fresnelNode1262_g15 = ( 0.04 + _IndirectSpecularSmoothness * pow( 1.0 - fresnelNdotV1262_g15, 5.0 ) );
				float3 lerpResult1236_g15 = lerp( temp_output_1210_0_g15 , switchResult1238_g15 , saturate( fresnelNode1262_g15 ));
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.FunctionNode;33;-240,0;Inherit;False;Material Sample;1;;14;09f1910db887ebd4cb569d6c76c63be3;4,251,0,216,0,263,0,346,1;0;12;FLOAT3;1;FLOAT3;6;FLOAT3;372;FLOAT3;328;FLOAT3;3;FLOAT3;5;FLOAT3;2;FLOAT3;4;FLOAT;8;FLOAT;71;FLOAT;72;FLOAT3;378
...
Node;AmplifyShaderEditor.FunctionNode;34;112,-64;Inherit;False;Material Lighting;40;;15;b5db59747a6f5584db32cde93c4695e4;9,1290,0,1289,0,1288,0,1074,0,1322,0,1323,0,1280,1,1128,1,1378,1;8;898;FLOAT3;0,0,0;False;975;FLOAT3;0,0,1;False;1081;FLOAT;0;False;1079;FLOAT;0;False;1077;FLOAT;0;False;1075;FLOAT;0;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;1;FLOAT3;894
Node;AmplifyShaderEditor.FunctionNode;50;112,272;Inherit;False;Material Baked GI;35;;31;4963945102cd7c746bbe83f48754e7cb;8,910,1,827,1,826,1,838,1,831,1,839,1,1322,0,1323,0;4;975;FLOAT3;0,0,1;False;765;FLOAT3;0,0,1;False;1246;FLOAT2;0,0;False;1250;FLOAT2;0,0;False;2;FLOAT3;948;FLOAT3;949
...
ASEEND*/
//CHKSM=08D8789A833CB16B13DC08133CEA54B407F55F66