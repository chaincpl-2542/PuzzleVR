	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float3 weightedBlend9_g93 = ( weightedBlendVar9_g93.x*( ( (Control26_g93).rrr * (_DiffuseRemapScale0).rgb ) * Splat0342_g93 ) + weightedBlendVar9_g93.y*( ( (Control26_g93).ggg * (_DiffuseRemapScale1).rgb ) * Splat1379_g93 ) + weightedBlendVar9_g93.z*( ( (Control26_g93).bbb * (_DiffuseRemapScale2).rgb ) * Splat2357_g93 ) + weightedBlendVar9_g93.w*( ( (Control26_g93).aaa * (_DiffuseRemapScale3).rgb ) * Splat3390_g93 ) );
				...
				float3 staticSwitch503_g93 = appendResult514_g93;
				#else
				float3 staticSwitch503_g93 = appendResult514_g93;
				#endif
				...
				float3 lerpResult976_g93 = lerp( staticSwitch503_g93 , SnowNormal858_g93 , SnowEnableRChannel925_g93);
				float SnowEnableGChannel896_g93 = _SnowSplatGEnable;
				float3 lerpResult978_g93 = lerp( staticSwitch503_g93 , SnowNormal858_g93 , SnowEnableGChannel896_g93);
				float SnowEnableBChannel897_g93 = _SnowSplatBEnable;
				float3 lerpResult979_g93 = lerp( staticSwitch503_g93 , SnowNormal858_g93 , SnowEnableBChannel897_g93);
				float SnowEnableAChannel899_g93 = _SnowSplatAEnable;
				float3 lerpResult982_g93 = lerp( staticSwitch503_g93 , SnowNormal858_g93 , SnowEnableAChannel899_g93);
				...
				float3 lerpResult1005_g93 = lerp( staticSwitch503_g93 , weightedBlend975_g93 , SnowEnable932_g93);
				...
				float weightedBlend536_g93 = ( weightedBlendVar536_g93.x*( ( 1.0 - _Metallic0 ) * Mask0R334_g93 ) + weightedBlendVar536_g93.y*( ( 1.0 - _Metallic1 ) * Mask1R370_g93 ) + weightedBlendVar536_g93.z*( ( 1.0 - _Metallic2 ) * Mask2R359_g93 ) + weightedBlendVar536_g93.w*( ( 1.0 - _Metallic3 ) * Mask3R388_g93 ) );
				
				float Mask0A335_g93 = tex2DNode416_g93.a;
				float Mask1A369_g93 = tex2DNode422_g93.a;
				float Mask2A360_g93 = tex2DNode419_g93.a;
				float Mask3A391_g93 = tex2DNode425_g93.a;
				float4 weightedBlendVar547_g93 = Control26_g93;
				float weightedBlend547_g93 = ( weightedBlendVar547_g93.x*( ( 1.0 - _Smoothness0 ) * Mask0A335_g93 ) + weightedBlendVar547_g93.y*( ( 1.0 - _Smoothness1 ) * Mask1A369_g93 ) + weightedBlendVar547_g93.z*( ( 1.0 - _Smoothness2 ) * Mask2A360_g93 ) + weightedBlendVar547_g93.w*( ( 1.0 - _Smoothness3 ) * Mask3A391_g93 ) );
				...
				float Smoothness = weightedBlend547_g93;
...
Node;AmplifyShaderEditor.FunctionNode;102;347.8021,40.57027;Inherit;False;Terrain 4 Layer;0;;93;a8a57459582f78d4ca5db58f601fb616;4,504,1,102,1,668,1,669,1;0;8;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;282;FLOAT3;709;FLOAT4;701
...
ASEEND*/
//CHKSM=628D9B917EA8E8B0463729DA2825FE68E3EEAAFE