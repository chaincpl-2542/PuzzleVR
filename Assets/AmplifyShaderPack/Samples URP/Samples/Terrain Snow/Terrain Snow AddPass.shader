	...
	UsePass "Hidden/Nature/Terrain/Utilities/SELECTION"
		...
		Pass
		{
			...
			VertexOutput VertexFunction( VertexInput v  )
			{
				...
				o.ase_texcoord8.xy = vertexToFrag851_g14;
						 ...
						 ) : SV_Target
			{
				...
				float2 vertexToFrag851_g14 = IN.ase_texcoord8.xy;
...
/*ASEBEGIN
Version=19302
Node;AmplifyShaderEditor.FunctionNode;53;320,48;Inherit;False;Terrain 4 Layer;0;;14;a8a57459582f78d4ca5db58f601fb616;4,504,1,102,1,668,1,669,1;0;8;FLOAT3;0;FLOAT3;14;FLOAT;56;FLOAT;45;FLOAT;200;FLOAT;282;FLOAT3;709;FLOAT4;701
...
ASEEND*/
//CHKSM=6D329EAEC9F6D1FBC772847528DB8A0D28A63046